import svgStack as ss
import os

doc = ss.Document()

layout1 = ss.HBoxLayout()
layout1.addSVG('fig_modelPredictionBurstsIndividual_VenancesBin0_v2.svg',alignment=ss.AlignTop|ss.AlignHCenter)
...
figname = 'fig_modelPredictionBurstsIndividual_VenancesBin0_complete_v2'

doc.save(figname+'.svg')
os.system('inkscape -f '+str(figname)+'.svg -A '+str(figname)+'.pdf')
os.system('convert '+str(figname)+'.pdf -quality 200 '+str(figname)+'.png')
